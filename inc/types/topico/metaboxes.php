...
function museo_historia_plugin_topico_perfil_meta_box(){
    global $post;
    $id = $post->ID;
    $fecha = get_post_meta($id,'museo_historia_plugin_topico_fecha',true);
    print "<div id='museo_historia_plugin_topico_fecha_container'>";
    print "<input name='museo_historia_plugin_topico_fecha_input'>";
    print "</div>";
